    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
          <span style={{ color: '#a78bfa', fontSize: '22px', fontWeight: 500, letterSpacing: '2px', fontFamily: 'Jost' }}>
            sammii.dev
          </span>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', position: 'relative', flex: 1, justifyContent: 'center', padding: '32px 0' }}>
          <span style={{ color: '#6b7280', fontSize: '16px', fontWeight: 500, letterSpacing: '2px', marginBottom: '16px', fontFamily: 'Jost' }}>
            CASE STUDY
          </span>
          <span style={{ color: '#ffffff', fontSize: `${titleFontSize}px`, fontWeight: 600, lineHeight: 1.2, maxWidth: '960px', fontFamily: 'Jost' }}>
            {title}
          </span>
        </div>
      </div>
