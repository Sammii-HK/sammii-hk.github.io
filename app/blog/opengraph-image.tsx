...
export const alt = 'Blog — sammii.dev';
      ...
      >
        <div
          style={{
            ...
            bottom: 0,
            background: [
              'radial-gradient(ellipse at 15% 30%, rgba(147, 51, 234, 0.3) 0%, transparent 50%)',
              'radial-gradient(ellipse at 85% 70%, rgba(59, 130, 246, 0.25) 0%, transparent 50%)',
            ].join(', '),
          }}
        />
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', position: 'relative' }}>
          ...
          <span style={{ color: '#9ca3af', fontSize: '28px', fontFamily: 'Jost', fontWeight: 500 }}>
